...
public class CompletedWorkshops extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_completed_workshops);
        ...
        getCompletedWorkshop();
    }

    public void getCompletedWorkshop() {
        loadinworkshops.setVisibility(View.VISIBLE);
        JSONObject headers = new JSONObject();
        String url = URL.GET_COMPLETED;
        headers = GLobalHeaders.getGlobalHeaders(CompletedWorkshops.this);
            ...
            public void onReceiving200SeriesResponse(RemoteResponse remoteResponse) {
                ...
                try {
                    ...
                    if (resultStatus.equals("200")) {
                        ...
                        suspendedWorkshopAdpter = new SuspendedWorkshopAdpter( (AppCompatActivity) CompletedWorkshops.this,workshops);
