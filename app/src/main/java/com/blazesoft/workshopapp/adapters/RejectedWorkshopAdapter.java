...
public class RejectedWorkshopAdapter extends BaseAdapter {
    ...
    public RejectedWorkshopAdapter(AppCompatActivity context, List<Workshop> Listdata){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final RejectedWorkshopAdapter.ViewHolder rowHolder;
        convertView = layoutInflater.inflate(R.layout.rejectedworkshop, parent, false);
        rowHolder = new RejectedWorkshopAdapter.ViewHolder();
